...
All audio files live in `public/sfx/`. The composition includes:

- Industrial ambiance loops (fade out before the closing slogan)
- Cell scan ticks as each cell appears
- Defect alert buzzer
- Tension hits for each ripple cell
- Whip sounds during the zoom-out
- AI sweep whoosh
- Stamp sounds on each sticker-text appearance
- Resolution dings after the AI sweep
